...
translate([-44.5-15,0,30+12]) rotate([0,90,0]) cylinder(h = 5, d=30+24, $fn = 90, center = true);  

translate([-44.5+5-15+0.5+5,0,30+12]) rotate([0,90,0]) cylinder(h = 6, d=50-0.3/*, d2=15*/, $fn = 90, center = true); 
...
translate([-44.5-15+5,0,30+12]) rotate([0,90,0]) cylinder(h = 5, d=14, $fn = 90, center = true);

translate([-44.5+5-15-5,0,30+12]) rotate([0,90,0]) cylinder(h = 5, d=8.25, $fn = 90, center = true);
...
translate([-70,0,30+12]){
difference(){


union(){
//body    
 rotate([0,90,0]) cylinder(h = 5, d=30+24, $fn = 90, center = true);  

// cube([5,50,25], center = true);
    
    
 translate([25,50,0])cube([60,40,8], center = true);    

    
}
translate([40,50,0]) rotate([90,0,0]) cylinder(h = 70, d=2.05, $fn = 90, center = true); 
 


rotate([0,90,0]) cylinder(h = 5, d=8.25, $fn = 90, center = true); 

translate([48,50,0]) cube([15,5+70,1], center = true);
