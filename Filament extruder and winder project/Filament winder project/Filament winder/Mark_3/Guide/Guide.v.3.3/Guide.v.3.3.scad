...
translate([30-2.5,0,0]) rotate([0,90,0]) cylinder(h = 24+5, d=15, $fn = 180, center = true);   
...
translate([0,8,0]) rotate([0,90,0]) resize([13+1.6,24+2,100]) cylinder(h = 100, d=10, $fn = 180, center = true);   

rotate([-90,0,0]) translate([30-2.5,0,7.7]) cube([24+5,15-1.5+1,15], center = true);

rotate([-90,0,0]) translate([-30+2.5,0,7.7]) cube([24+5,15-1.5,15], center = true);
