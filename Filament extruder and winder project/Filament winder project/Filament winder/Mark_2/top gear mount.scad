...
translate([30,-0.6,0]){
difference(){
rotate([0,0,0]) translate([0,0,0]) cylinder(h = 28, d=17, $fn = 180, center = true);   
...
translate([-30,-50+5+3,0.5]){
difference(){
rotate([0,0,0]) translate([0,0,-2]) cylinder(h = 45.5, d=17, $fn = 180, center = true);   
    
rotate([0,0,0]) translate([0,0,-2]) cylinder(h = 50, d=8+0.25, $fn = 180, center = true);
...
//left back skew attachment
translate([-30,-50+5+3-30-2,0]){
difference(){
...
//baseplate
translate([0,2.5,0]) rotate([90,0,0]) cube([48+10,15,10], center = true);
  
  
    
translate([29.75,-40,0]) rotate([90,0,0]) cube([17,15,80], center = true);    
...
translate([-30,-50+5+3-30-2-17/2,0])rotate([-25,15,0]) translate([0,0,0]) cube([25,17,80], center = true);


translate([-30-17,-50+5+3-30-2,0])rotate([-25,15,10]) translate([0,0,0]) cube([17,17,80], center = true);
}
...
//front cylinder emptying
for(i=[0:1]) mirror([i,0,0])translate([30,-0.6,0]) rotate([0,0,0]) translate([0,0,0]) cylinder(h = 50, d=9, $fn = 180, center = true);


//back skew cylinder emtyping
for(i=[0:1]) mirror([i,0,0]) translate([30,-50+5+3-30-2,0]) rotate([-25,-15,0]) translate([0,0,0]) cylinder(h = 50, d=8+0.25, $fn = 180, center = true);


//back cylinder emtyping
for(i=[0:1]) mirror([i,0,0]) translate([30,-50+5+3,0]) rotate([0,0,0]) translate([0,0,-2]) cylinder(h = 50, d=8+0.25, $fn = 180, center = true);


//skew cylinder emtyping
for(i=[0:1]) mirror([i,0,0]) translate([-30,-21,0]) rotate([0,15,0]) translate([0,0,0]) cylinder(h = 50, d=8+0.25, $fn = 180, center = true);
...
//middle hole    
rotate([90,0,0]) cylinder(h = 5, d=12, $fn = 180, center = true);    
...
for(i=[0:1]) mirror([i,0,i]) rotate([0,45,0]) translate([0,0,36.6/2]) rotate([90,0,0]) cylinder(h = 20, d=5.3, $fn = 180, center = true);
