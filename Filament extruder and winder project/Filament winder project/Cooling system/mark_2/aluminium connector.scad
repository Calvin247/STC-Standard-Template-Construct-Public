...
union(){    
translate([0,0,-3]) rotate([0,45,0]) cube([35+5,25,35+5], center = true);    
    
//pillar
translate([0,7.5,-30])cube([20,10,70], center = true);    
...
for(i=[1,3]) rotate([0,i*45,0]) translate([13.5-2.5,0,0]) cube([3.5,25.2,25.5], center = true);
    
 translate([0,0,18]) rotate([0,45,0]) cube([35,26,35], center = true);     

rotate([0,45,0])cube([20,26,20], center = true); 
