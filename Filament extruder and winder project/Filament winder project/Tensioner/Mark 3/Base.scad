...
Ra=0;    //rotate
translate([10,12,0]) rotate([0,0,Ra]) Lever();

Rb=30;
translate([-22,12,0])rotate([0,0,Rb]) Latch();
...
for(i=[0,1]) translate([-32*i+10,12,0])cylinder(h = 60, d=27,$fn= A, center = true);
    
//slanting the wall
translate([0,0,7.5+11.45]) rotate([0,5.83,0]) cube([150,6,20],center = true);
}

translate([-4.5,0,7.5]) cube([10,5,10], center = true);
   
for(i=[1]) mirror([i,0,0]) translate([50,0,0])cylinder(h = 5, d=30, $fn = A, center = true);
    
//middle cylinder 
translate([-50,0,7.5])cylinder(h = 10, d=30, $fn = A,center = true);

//translate([-50,9.5,7.5])cylinder(h = 30, d=10, $fn = A,center = true);


//bearing 2
translate([-50-40,0,5])cylinder(h = 15, d=30, $fn = A,center = true); 
...
//middle circles
for(i=[0,1]) translate([-32*i+10,12,0])cylinder(h = 5, d=25, $fn=A,center = true);
for(i=[0,1]) translate([-32*i+10,12,3.5])cylinder(h = 2, d1=25,d2=10, $fn = A, center = true);
for(i=[0,1]) translate([-32*i+10,12,-3.5])cylinder(h = 2, d1=10,d2=25, $fn = A, center = true);
...
for(i=[0,1]) translate([-32*i+10,12,3.5])cylinder(h = 60, d=5.25, $fn = A, center = true);


//front fitting elimination
for(i=[0:20]) rotate([0,0,i*0.5]) translate([50,12,0])cylinder(h = 10, d=18.25, $fn = A, center = true);
translate([50,12+18.25/2,0]) cube([18.25,18.25,20], center = true);

//middle back cylinder hole
translate([-50,0,5])cylinder(h = 50, d=8.25, $fn = A, center = true);

//back cylinder hole
translate([-50-40,0,5])cylinder(h = 50, d=8.25, $fn = A,center = true);


translate([-50,0,7.5]) rotate([90,0,0]) cylinder(h = 40, d=3.2,$fn = B, center = true); 
...
//Front cylinder
translate([40,0,10-3.5])cylinder(h = 12, d=18, $fn = A, center = true);
...
//cube center
translate([15,0,10]) cube([50,15,5], center = true);
...
//holes
translate([40,0,10])cylinder(h = 60, d=5.25, $fn = A, center = true);
