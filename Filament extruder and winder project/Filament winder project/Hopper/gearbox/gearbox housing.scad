...
//for(i=[-1,1])for(j=[0,1])translate([-35,i*(40+22),10+j*95])spacer();
    
//for(i=[-1,1])for(j=[0,1])translate([63.25+35,i*(40+22),10+j*95])spacer();


//for(i=[-1,1])for(j=[1])translate([-35,i*(40+22),10+j*47])spacer_small();
...
for(i=[-1,1])translate([0,i*30,0])cylinder(h = 11, d=5.2, $fn = 180, center = true);
...
//connector holes/////
for(i=[-1,1])translate([63.25+35,i*(40+22),0]) cylinder(h = 100, d=5.25, $fn = 180, center = true);
    
for(i=[-1,1])translate([-35,i*(40+22),0]) cylinder(h = 100, d=5.25, $fn = 180, center = true);
/////////////////////
