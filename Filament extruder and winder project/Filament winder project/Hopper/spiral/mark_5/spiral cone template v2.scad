...
translate([0,0,105])cube([120,120,20], center = false);

}

rotate_extrude(angle = 360, $fn=30) polygon([[8,0],[30,0],[50,120],[8,120]], paths=[[0,1,2,3]]);
...
translate([0,0,0])cylinder(h = 130, d=16, $fn = 30, center = false);
}

translate([0,0,0])cylinder(h = 300, d=8.25, $fn = 30, center = true);


translate([0,0,116])rotate([0,90,50])cylinder(h = 120, d=3.25, $fn = 30, center = true);


//translate([0,0,5])rotate([0,90,45])cylinder(h = 120, d=3.25, $fn = 30, center = true);
