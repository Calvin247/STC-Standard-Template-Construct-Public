...
for(i=[0:1]) rotate([-45+22-i*44,0,0]) translate([-2.5,12.5,0]) rotate([0,90,0]) cylinder(h = 5, d=6.5, $fn = 6, center = true);   
...
translate([10,0,0]) translate([0,0,8.5]) rotate([0,90,0]) cylinder(h = 10, d=40, $fn = 90, center = true); 
